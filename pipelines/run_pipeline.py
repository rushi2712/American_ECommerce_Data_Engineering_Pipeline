...
subprocess.run(["python", r"C:\Users\ptrus\IdeaProjects\data-engineering-project\pipelines\ingestion.py"], check=True)

print("\nStep 2: Running Data Transformation...")
subprocess.run(["python", r"C:\Users\ptrus\IdeaProjects\data-engineering-project\pipelines\transformation.py"], check=True)
